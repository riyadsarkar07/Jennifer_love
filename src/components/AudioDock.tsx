  ...
  return (
    <div className="fixed right-3 top-3 z-50 flex items-center gap-2 sm:right-4 sm:top-4">
      <button
        ...
        className="flex h-11 w-11 items-center justify-center rounded-full border border-gold/40 bg-plum-light/80 text-gold shadow-lg backdrop-blur-md transition-transform active:scale-90"
      >
      ...
      <button
        ...
        className={`flex h-11 w-11 items-center justify-center rounded-full border border-gold/40 bg-plum-light/80 shadow-lg backdrop-blur-md transition-transform active:scale-90 ${
